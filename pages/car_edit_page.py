...
from locators.body_locators.profile_locators.car_locators import CarLocators


class CarEditPage(BasePage):
    car_brand = 'Toyota'
    car_model = 'Supra'
    car_year = '1998'
    __max_cars_count = 3
    ...
    def cars_count(self):
        if not self.presence_of_element_located(CarLocators.ALL_CARS):
            return 0
        return len(self.elements_are_visible(CarLocators.ALL_CARS))
